...
.slds-popover_brand-top {
  ...
  &.slds-popover_brand-dark {
    border-top-color: $color-border-inverse;
...
.slds-popover_brand-left {
  ...
  &.slds-popover_brand-dark {
    border-left-color: $color-border-inverse;
...
.slds-popover_brand-bottom {
  ...
  &.slds-popover_brand-dark {
    border-bottom-color: $color-border-inverse;
...
.slds-popover_brand-right {
  ...
  &.slds-popover_brand-dark {
    border-right-color: $color-border-inverse;
