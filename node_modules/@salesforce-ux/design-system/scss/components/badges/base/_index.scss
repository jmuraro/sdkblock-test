...
.slds-badge {
  ...
  color: var(--slds-c-badge-text-color, var(--sds-c-badge-text-color, $color-text-default));
  ...
  background-color: var(--slds-c-badge-color-background, var(--sds-c-badge-color-background, $color-background-dark));
...
.slds-badge_inverse {
  ...
  --slds-c-badge-color-background: var(--slds-c-badge-inverse-color-background, var(--sds-c-badge-inverse-color-background, #{$badge-color-background-inverse}));

  /*! @css-var-fallback color */
  --slds-c-badge-text-color: var(--slds-c-badge-inverse-text-color, var(--sds-c-badge-inverse-text-color, #{$color-text-inverse}));
}
...
.slds-badge_lightest {
  /*! @css-var-fallback background-color */
  --slds-c-badge-color-background: var(--slds-c-badge-lightest-color-background, var(--sds-c-badge-lightest-color-background, #{$badge-color-background-lightest}));

  /*! @css-var-fallback border-color */
  --slds-c-badge-color-border: var(--slds-c-badge-lightest-color-border, var(--sds-c-badge-lightest-color-border, #{$color-border}));
}
...
.slds-badge__icon {
  display: inline-flex;
  align-items: center;
  color: var(--slds-c-badge-icon-color-foreground, var(--sds-c-badge-icon-color-foreground, $color-text-icon-default));
  line-height: 1;
