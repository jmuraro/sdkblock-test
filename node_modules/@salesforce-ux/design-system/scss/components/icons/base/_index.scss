...
.slds-icon {
  ...
  fill: var(--slds-c-icon-color-foreground, var(--sds-c-icon-color-foreground, $color-text-icon-inverse));
}
...
.slds-icon-text-default {
  ...
  --slds-c-icon-color-foreground: var(--slds-c-icon-color-foreground-default, var(--sds-c-icon-color-foreground-default, #{$color-text-icon-default}));
...
.slds-icon-text-warning {
  /*! @css-var-fallback fill */
  --slds-c-icon-color-foreground: #{$color-text-warning};
}
...
.slds-icon-text-success {
  /*! @css-var-fallback fill */
  --slds-c-icon-color-foreground: #{$color-text-success};
}
...
.slds-icon-text-error {
  /*! @css-var-fallback fill */
  --slds-c-icon-color-foreground: #{$color-text-error};
}
...
.slds-icon-text-light {
  /*! @css-var-fallback fill */
  --slds-c-icon-color-foreground: #{$color-text-input-icon};
}
