...
@mixin range-thumb {
  ...
  border: 0;
  box-shadow: var(--slds-c-slider-thumb-shadow, var(--sds-c-slider-thumb-shadow, $slider-handle-shadow));
  cursor: pointer;
...
@mixin range-track {
  ...
  cursor: pointer;
  background: none; // Reset underlying styles
  background-color: var(--slds-c-slider-track-color-background, var(--sds-c-slider-track-color-background, $slider-track-color-background));
