...
.slds-popover--tooltip {
  ...
  background-color: var(--slds-c-tooltip-color-background, var(--sds-c-tooltip-color-background, $color-background-alt-inverse));
  border: 0;

  .slds-popover__body {
    font-size: var(--slds-c-tooltip-font-size, var(--sds-c-tooltip-font-size, $font-size-2));
    color: var(--slds-c-tooltip-text-color, var(--sds-c-tooltip-text-color, $color-text-inverse));
  }
}
