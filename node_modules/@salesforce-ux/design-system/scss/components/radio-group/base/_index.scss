...
.slds-radio {
  ...
  .slds-radio--faux {
    ...
    border: $border-width-thin solid var(--slds-c-radio-color-border, var(--sds-c-radio-color-border, $color-border-input));
    border-radius: $border-radius-circle;
    background: none;
    background-color: var(--slds-c-radio-color-background, var(--sds-c-radio-color-background, $color-background-input));
  ...
  [type="radio"] {
    ...
    &:checked + .slds-radio__label .slds-radio--faux {
      border-color: var(--slds-c-radio-color-border-checked, var(--sds-c-radio-color-border-checked, var(--sds-c-radio-color-border, $color-border-input)));
      background: none;
      background-color: var(--slds-c-radio-color-background-checked, var(--sds-c-radio-color-background-checked, var(--sds-c-radio-color-background, $color-background-input)));
    ...
    &:focus + .slds-radio__label .slds-radio--faux {
      border-color: var(--slds-c-radio-color-border-focus, var(--sds-c-radio-color-border-focus, $color-border-input-active));
