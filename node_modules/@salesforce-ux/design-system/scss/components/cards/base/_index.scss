...
.slds-card {
  ...
  background: var(--slds-c-card-color-background, var(--sds-c-card-color-background, $card-color-background));
  border-width: var(--slds-c-card-sizing-border, var(--sds-c-card-sizing-border, $border-width-thin));
  border-style: solid;
  border-color: var(--slds-c-card-color-border, var(--sds-c-card-color-border, $card-color-border));
...
.slds-card__footer {
  ...
  border-top-color: var(--slds-c-card-footer-color-border, var(--sds-c-card-footer-color-border, $card-footer-color-border));
}
