...
.slds-tabs--default__nav {
  ...
  border-bottom-color: var(--slds-c-tabs-list-color-border, var(--sds-c-tabs-list-color-border, $color-border));
}
...
.slds-tabs--default__item {
  color: var(--slds-c-tabs-item-text-color, var(--sds-c-tabs-item-text-color, $color-text-action-label));
  position: relative;
  ...
  &.slds-is-active {
    ...
    --slds-c-tabs-item-text-color: var(--slds-c-tabs-item-text-color-active, var(--sds-c-tabs-item-text-color-active, #{$color-text-action-label-active}));
