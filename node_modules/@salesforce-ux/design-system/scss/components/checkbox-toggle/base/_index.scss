...
.slds-checkbox--toggle {
  ...
  .slds-checkbox--faux {
    ...
    border-color: var(--slds-c-checkbox-toggle-color-border, var(--sds-c-checkbox-toggle-color-border, $color-background-toggle));
    padding: $spacing-xxx-small;
    // @todo consider shared hooks for inputs
    background-color: var(--slds-c-checkbox-toggle-color-background, var(--sds-c-checkbox-toggle-color-background, $color-background-toggle));
    ...
    &:focus {
      ...
      --slds-c-checkbox-toggle-color-background: var(--slds-c-checkbox-toggle-color-background-hover, var(--sds-c-checkbox-toggle-color-background-hover, #{$color-background-toggle-hover}));
    ...
    &:after {
      ...
      background-color: var(--slds-c-checkbox-toggle-switch-color-background, var(--sds-c-checkbox-toggle-switch-color-background, $color-background-alt));
      // @todo consider global hook
      border-radius: var(--slds-c-checkbox-toggle-radius-border, var(--sds-c-checkbox-toggle-radius-border, $border-radius-pill));
    }
  }
  ...
  [type='checkbox'] {
    ...
    &:focus {
      ...
      + .slds-checkbox--faux_container .slds-checkbox--faux {
        // @todo consider shared hooks for inputs
        /*! @css-var-fallback background-color */
        --slds-c-checkbox-toggle-color-background: var(--sds-c-checkbox-toggle-color-background-focus, #{$color-background-toggle-hover});

        // @todo consider shared hooks for inputs
        /*! @css-var-fallback border-color */
        --slds-c-checkbox-toggle-color-border: var(--sds-c-checkbox-toggle-color-border-focus, #{$color-border-input-active});
    ...
    &:checked {
      ...
      + .slds-checkbox--faux_container .slds-checkbox--faux {
        ...
        &:after {
          ...
          border-bottom-color: var(--slds-c-checkbox-toggle-mark-color-foreground, var(--sds-c-checkbox-toggle-mark-color-foreground, $color-border-toggle-checked));
          /* stylelint-disable comment-empty-line-before */
          /*! @noflip */
          border-right-width: $border-width-thick;
          border-right-style: solid;
          border-right-color: var(--slds-c-checkbox-toggle-mark-color-foreground, var(--sds-c-checkbox-toggle-mark-color-foreground, $color-border-toggle-checked));
