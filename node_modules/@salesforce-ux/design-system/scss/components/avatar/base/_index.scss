...
.slds-avatar {
  ...
  color: var(--slds-c-avatar-text-color, var(--sds-c-avatar-text-color, $color-text-inverse));
...
.slds-avatar__initials {
  ...
  &:hover {
    color: var(--slds-c-avatar-initials-text-color-hover, var(--sds-c-avatar-initials-text-color-hover, $color-text-inverse));
    cursor: default;
  }
}
...
.slds-avatar__initials_inverse {
  ...
  --slds-c-avatar-initials-text-color: var(--slds-c-avatar-initials-inverse-text-color, #{$color-text-weak});
  ...
  &:hover {
    /*! @css-var-fallback color */
    --slds-c-avatar-initials-text-color-hover: var(--slds-c-avatar-initials-inverse-text-color-hover, #{$color-text-weak});
  }
}
